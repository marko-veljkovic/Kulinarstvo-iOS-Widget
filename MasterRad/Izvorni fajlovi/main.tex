...
\indent Swift jе модеран програмски jезик опште намене, настао 2014. године у оквиру компаниjе Apple. Првенствено jе намењен развоjу апликациjа на њиховим платформама (iOS, iPadOS, macOS, tvOS и watchOS), али jе део развоjа jезика усмерен ка поjедностављивању процеса израде корисничког интерфеjса и увођењу декларативне синтаксе у jезик. У том контексту настало jе радно окружење SwiftUI коjе одликуjе могућност брзог креирања концизних и ефикасних решења. Пример примене радног окружења SwiftUI jе израда виџета намењених оперативним системима iOS, iPadOS и macOS. 
\\
\indent Виџет, као део мобилне апликациjе, се налази на почетном екрану уређаjа (телефона или таблета) и кориснику приказуjе одабране важне информациjе из те апликациjе. За разлику од виџета у оперативном систему Android, коjи су присутни више од десет година, виџети на Apple платформама су уведени 2020. године, тако да jе и сама технологиjа коjа подржава њихово креирање и даље у активном развоjу.
\\
\indent Циљ рада jе истраживање и опис карактеристика и могућности коjе пружа програмски jезик Swift, промене и побољшања коjе jе донело радно окружење SwiftUI и приказ новина насталих увођењем виџета (конкретно у оперативном систему iOS). У оквиру рада биће имплементирана iOS апликациjа о кулинарству "Кулинарство - сласно и ефикасно" коришћењем програмског jезика Swift, након чега ће бити креиран одговараjући виџет помоћу радног окружења SwiftUI. Оваj виџет пружаће кориснику помоћ приликом избора и припреме оброка.
...
\begin{figure} [H]
    ...
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - overview.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - overview.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - category.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - category.png}
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - choosen category.png}
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - choosen category.png}
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - search.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - search.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - sort asc.png}
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - sort asc.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - favorites.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - favorites.png}
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - my recipes.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - my recipes.png}
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - detail4.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - detail4.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - detail6.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - detail6.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - new.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - new.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - change.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - change.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - ingredients2.png}
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - ingredients2.png}
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - steps2.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - steps2.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - delete.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - delete.png}
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - add widget.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - add widget.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - widgets 1-1.png}
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - widgets 1-1.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - widgets 1-2.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - widgets 1-2.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - change widget.png}
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - change widget.png} 
...
\begin{figure} [H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.475\textwidth]{images/simulators/dark - widgets 2-1.png} 
    \hfill
    \includegraphics[width=0.475\textwidth]{images/simulators/light - widgets 2-1.png}
